...
func (cfg AWSConfig) Flags(flags *pflag.FlagSet) {
	...
	flags.String(operatorOption.AWSCrossAccountRoleARN, awsDefaultConfig.AWSCrossAccountRoleARN, "ARN of the IAM role in the dedicated rbx-cilium account for cross-account IPAM")
}
